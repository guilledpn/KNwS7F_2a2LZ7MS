...
| ADR-025 | Estructura mínima del desarrollo comercial | <span style="color:red">Consolidado en ADR, Modelo Comercial y Matriz · pendiente de revisión final</span> | `docs/adr/ADR-025-estructura-minima-desarrollo-comercial.md` | LCD-20260802-01 |
