...
| ADR-028 | Infraestructura independiente y corte total de CRM Patrimonial Next | Candidato | `docs/adr/ADR-028-infraestructura-independiente-y-corte-total-next.md` | LCD-20260805-01 |
